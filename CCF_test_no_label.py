...
def do_CCF(ccf_specs, work_path, fits_path, wave=np.arange(3950, 5750, 1)):
    """
...
if __name__ == '__main__':
    ...
    start = time.time()
    results = do_CCF(ccf_specs=CCF_specs, work_path=work_path, fits_path=input_template_All[:3],
                     wave=np.arange(3950, 5750, 1))
